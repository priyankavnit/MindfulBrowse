...
exports.groupIntoSessions = groupIntoSessions;
exports.isDoomscrollSession = isDoomscrollSession;
exports.checkHighScrollActivity = checkHighScrollActivity;
exports.checkDoomscrollCategory = checkDoomscrollCategory;
exports.checkDomainRepetition = checkDomainRepetition;
exports.detectDoomscroll = detectDoomscroll;
...
function isDoomscrollSession(session) {
    if (session.length === 0) {
        return false;
    }
...
function checkHighScrollActivity(session) {
    if (session.length === 0) {
        return false;
    }
...
async function detectDoomscroll(recentEvents, currentEvent) {
...
//# sourceMappingURL=doomscroll-detector.js.map