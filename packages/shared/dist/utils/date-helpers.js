 ...
 */
export function isValidISODateTime(datetimeString) {
 ...
 */
export function getTTLTimestamp(daysFromNow) {
    const date = new Date();
 ...
 */
export function formatDateTimeForDisplay(datetimeString, locale = 'en-US') {
    const date = new Date(datetimeString);
    return date.toLocaleDateString(locale, {
        year: 'numeric',
        month: 'short',
 ...
 */
export function getRelativeTimeString(datetimeString) {
    const date = new Date(datetimeString);
    const now = new Date();
